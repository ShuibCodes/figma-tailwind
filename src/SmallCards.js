...
export default function SmallCards() {
	return (
		...
		<div className="pl-6 md:pl-7 md:flex space-y-12 md:space-y-3 md:space-x-8  md:py-8 ">
			<div
				style={{ backgroundColor: '#0E1C34', height: '200px', minWidth: '330px' }}
				className="rounded-3xl overflow-hidden shadow-xl max-w-xs my-3 "
			>
				<img style={{ width: '360px' }} src="http://placehold.jp/270x80.png" alt="cover-image" className=" h-24" />
				<div className="flex justify-center rounded-lg">
					<img
						src="https://i.imgur.com/8Km9tLL.jpg"
						alt="small-card-avatar"
						className="rounded-full border-solid border-white border-0 -mt-12 rounded-lg"
					/>
				</div>
				<div className="text-center px-3 py-4 pb-6 pt-2">
					<p className="mt-2 font-lexend text-white"> Jerome Bell</p>
					<span  className="font-lelexend text-gray-300 " >$123.5K</span>
				</div>
			</div>
			...
			>
				...
				<div className="text-center px-3 py-4 pb-6 pt-2">
					<p className="mt-2 font-lexend  text-white"> Jerome Bell</p>
					<span  className="font-lexend text-gray-300 " >$123.5K</span>
				</div>
			</div>
			<div
				style={{ backgroundColor:'#0E1C34', height: '200px', minWidth: '330px' }}
